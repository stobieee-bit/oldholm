  ...
  giant_rat: {
    ...
    model: {
      ...
      parts: [
        ...
        { kind: 'sphere', r: 0.13, scale: [1, 1.15, 1.3], at: [-0.15, 0.2, 0.16], color: 0x6e6258 },
        { kind: 'sphere', r: 0.13, scale: [1, 1.15, 1.3], at: [0.15, 0.2, 0.16], color: 0x6e6258 },
        { kind: 'sphere', r: 0.19, scale: [1.05, 0.85, 1.5], at: [0, 0.33, 0.02], color: 0x6e6258 },
      ],
    },
  },
  ...
  bear: {
    ...
    model: {
      ...
      parts: [
        ...
        { kind: 'box', size: [0.17, 0.05, 0.09], at: [0.26, 0.03, -0.47], color: 0xd8ccb8 },
        { kind: 'sphere', r: 0.08, at: [0, 0.84, 0.68], color: 0x4a3520 },
      ],
    },
  },
  hill_giant: {
  ...
  giant_frog: {
    ...
    model: {
      ...
      parts: [
        ...
        { kind: 'sphere', r: 0.13, scale: [1.2, 0.8, 0.9], at: [0, 0.15, -0.3], color: 0x9ab86a },
        { kind: 'box', size: [0.13, 0.05, 0.17], at: [-0.17, 0.025, -0.32], color: 0x4a7a2a },
        { kind: 'box', size: [0.13, 0.05, 0.17], at: [0.17, 0.025, -0.32], color: 0x4a7a2a },
        { kind: 'sphere', r: 0.05, at: [-0.12, 0.58, 0.08], color: 0x4a7a2a },
        { kind: 'sphere', r: 0.04, at: [0.14, 0.55, 0.16], color: 0x4a7a2a },
      ],
    },
  },
  mugger: {
  ...
  cave_crawler: {
    ...
    model: {
      ...
      parts: [
        ...
        { kind: 'sphere', r: 0.1, at: [0, 0.46, 0.22], color: 0x5a5468 },
      ],
    },
  },
  crystal_scuttler: {
